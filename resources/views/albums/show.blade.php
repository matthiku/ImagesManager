...
<div class="container-fluid"
		...
		<p><a href="/validated/albums/create-album" class="btn btn-primary" role="button">Add Album</a></p>
			    ...
			    <div class="thumbnail">
			      <div class="caption">
			        ...
			        <form action="/validated/albums/delete-album" method="POST">
						...
						<input type="checkbox" name="delPhotos" id="delPhotos">Delete containing photos
					</form>
			      </div>
			    </div>
			  </div>
	...
	<div class="alert alert-danger">
		<p>You don't have any album yet. <a href="/validated/albums/create-album">Create one</a>.</p>
	</div>
	@endif
